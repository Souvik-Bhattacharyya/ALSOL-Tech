    ...
    <nav id="navbar" style="border-radius: 0; transition: all .5s ease;"
        ...
        <div class="container" id="nav-container">
            <a class="navbar-brand" href="./index.html">
                <div class="animate__animated animate__bounceInDown" id="logo">
                </div>
            </a>
                    ...
                    <ul class="nav-cont-ul ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="mailto:team@alsoltech.com"><i
                                    class="fa fa-envelope fa-lg me-2"></i> team@alsoltech.com</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"> <i class="fa fa-map fa-lg me-2"></i> Kolkata, India</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"> <i class="fa fa-phone fa-lg me-2"></i> 7980222011 / 9064286385</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text px-4">Shivalay Apartment, 3rd Floor, East Enclave bus Stand, near- Coal Bhawan/
